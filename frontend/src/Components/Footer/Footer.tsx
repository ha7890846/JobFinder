    ...
    <div className="flex flex-col gap-2">
      <div className="pt-20 pb-5 bg-mine-shaft-950 p-4  flex gap-8 justify-around flex-wrap">
        ...
        >
          ...
          <div className="flex gap-3 text-bright-sun-400 [&>a]:bg-mine-shaft-900 [&>a]:p-2 [&>a]:rounded-full [&>a]:cursor-pointer hover:[&>a]:bg-mine-shaft-700">
            <a href="mailto:habib.shah2023@outlook.com" aria-label="Send email">
              <IconBrandTelegram />
            </a>
            <a href="https://www.linkedin.com/in/habib2023/">
              <IconBrandLinkedin />
            </a>
            <a href="https://leetcode.com/Habib_shah2023/">
              <IconBrandLeetcode />
            </a>
          </div>
        </div>
      ...
      >
        ...
        <a
          ...
          href="https://github.com/ha7890846"
        >
          Habib Shah
        </a>
      </div>
