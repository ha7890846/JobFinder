...
const JobCard=(props:any)=>{
    return (
        <Link to="/jobs" className="bg-mine-shaft-900 p-5 w-80 flex flex-col gap-2 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 transition duration-300 ease-in-out ">
            <div className="flex justify-between">
                ...
                {props.saved?<IconBookmarkFilled className="text-bright-sun-400 cursor-pointer"/>:<IconBookmark className=" text-mine-shaft-300 cursor-pointer" stroke={1.5} />}
            </div>
            ...
            }
            {
                props.interviewing &&<div className="flex gap-1 text-mine-shaft-200 text-sm items-center">
                          <IconCalendarMonth className="text-bright-sun-400 w-5 h-5" stroke={1.5}/>Sun,25 Aug &bull; <span className="text-mine-shaft-400">10:00AM</span>
                        </div>
            }
        </Link>
    )
