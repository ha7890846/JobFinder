...
const JobDesc = () => {
  ...
  return (
    <div className="w-2/3">
      ...
      <Divider my="xl" />
      <div>
        <div className="text-xl font-semibold mb-5">Required Skill</div>
      ...
      <div>
        ...
        <div className="text-mine-shaft-300 text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempore hic quas amet aperiam, rem explicabo assumenda eveniet dignissimos consequuntur id at, dicta voluptatibus. Recusandae consequuntur, accusamus aspernatur rem ut debitis dolores eum explicabo totam sequi nisi unde, ea, nulla dolorem.</div>
      </div>
    </div>
  );
};
